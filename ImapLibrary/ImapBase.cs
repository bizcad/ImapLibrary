...
namespace Joshi.Utils.Imap
{
    public class ImapBase
    {
        ...
        private void FileLog(LogTypeEnum type, string log)
        {
            switch (type)
            {
                case LogTypeEnum.INFO:
                    WriteFileStream("Info:" + log);
                    break;
                case LogTypeEnum.WARN:
                    WriteFileStream("Warning:" + log);
                    break;
                case LogTypeEnum.ERROR:
                    WriteFileStream("Error:" + log);
                    break;
        ...
        public void WriteFileStream(string message)
        {
            using (var fs = new StreamWriter(AssemblyLocator.ExecutingDirectory() + "log.txt", true))
            {
        ...
        public void ConsoleLog(LogTypeEnum type, string log)
        {
            switch (type)
            {
                case LogTypeEnum.INFO:
